  ...
  process.env.NODE_ENV !== "development"
    ...
    : (conf) => {
        const sizeTokenKeys = ["$true"],
          ...
          tamaguiConfig2 = (0, import_core.createTamagui)(conf);
        ...
        return (
          ...
          animation &&
            (Array.isArray(style.transform) &&
              (style.transform = (0, import_web.transformsToString)(
                style.transform,
              )),
...
var lightTheme = {
  ...
  backgroundStrong: palette.sky.lighter,
  // e.g. selected item background
  ...
  primarySoft: palette.primary.lightest,
  // ghost / chip background
  primaryBorder: palette.primary.light,
  primaryText: palette.common.white,
  // text on primary background
  primaryTextSoft: palette.primary.darkest,
  // text on primarySoft background
...
var sarabunFont = (0, import_core2.createFont)({
  family: fontFamily,
  size: {
    1: fontSize.tiny,
    2: fontSize.small,
